...
Числа — это буквы другого алфавита. Каждая буква имеет своё числовое значение. А — 1, Б — 2, В — 3, и так далее. Сложи буквы слова — получишь его число. Это число — ключ к пониманию слова.

Слово «храм»: Х — 5, Р — 9, А — 1, М — 5. Сумма: 5+9+1+5 = 20 = 2+0 = 2. Двойка — число связи, соединения. Храм соединяет небо и землю.

Слово «вода»: В — 3, О — 7, Д — 5, А — 1. Сумма: 3+7+5+1 = 16 = 1+6 = 7. Семёрка — число тайны, мудрости. Вода хранит тайны.

Слово «жизнь»: Ж — 8, И — 1, З — 9, Н — 6, Ь — 3. Сумма: 8+1+9+6+3 = 27 = 2+7 = 9. Девятка — число завершения, полноты. Жизнь стремится к полноте.

Так можно расшифровать любой текст, любое имя, любое понятие. Числовой профиль текста показывает его истинную природу, скрытую за словами.
